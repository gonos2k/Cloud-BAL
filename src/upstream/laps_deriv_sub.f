...
c     Cloud-BAL: original-upstream writer status, no science changes.
...
!       Write out Cloud derived Omega field
        ...
        units_a(1) = units
        comment_a(1) = comment
        j_status(n_lco) = sys_abort_prod
        call put_laps_multi_3d(i4time,ext,var_a,units_a,comment_a
     1                      ,w_3d,NX_L,NY_L,NZ_L,1,istatus)
