        ...
        if ( strcon .eq. 2 ) then
         if (rand_index .eq. 2) then
          ...
          if (depth.ne.0) then
           ...
           write(6,*) 'depth =',depth, 'No changes to ratio...1'
          endif
...
!            if(ratio_radar .gt. ratio) ratio = ratio_radar
           ...
           write(6,*) 'depth =',depth, 'No changes to ratio...2'
          endif
         endif
     ...
     1       temp(ktop) .gt. 0.) then 
          if (rand_index .eq. 2) then
           ...
           if (depth.ne.0) then
            ...
            write(6,*) 'depth =',depth, 'No changes to ratio...3'
           endif
          else     !  for rand_index = 1
           ratio = ratio * 0.001
           ratio_radar=0.
           ...
           if (depth.ne.0) then
            ...
            write(6,*) 'depth =',depth, 'No changes to ratio...4'
           endif
          endif
          Do k = 1, ktop
            vv = Parabolic_vv_profile (zbase, ztop, ratio, heights(k))
...
30        continue
          ...
          if( rand_index .eq. 2) then
           ...
           if (depth.ne.0) then
            ...
            write(6,*) 'depth =',depth, 'No changes to ratio...5'
           endif
          else    ! for rand_index = 1
           ratio = ratio * 0.001
           ratio_radar=0.
           ...
           if (depth.ne.0) then
            ...
            write(6,*) 'depth =',depth, 'No changes to ratio...6'
           endif
          endif
          do k = 1, kmiddle
           vv = Parabolic_vv_profile (zbase, ztop, ratio, heights(k))
          ...
          if (rand_index .eq. 2) then
           ...
           if (depth.ne.0) then
            ...
            write(6,*) 'depth =',depth, 'No changes to ratio...7'
           endif
          else      ! for rand_index = 1
           ratio = ratio * 0.001
           ratio_radar=0.
           ...
           if (depth.ne.0) then
            ...
            write(6,*) 'depth =',depth, 'No changes to ratio...8'
           endif
          endif
          do k = kmiddle, ktop
